...
{
   public static class StorageNetConfigurationExtensions
   {
      /// <summary>
      ...
      /// </summary>
      public static ConfigurationBuilder<TInterface> UseStorageNetBlobs<TInterface>(
         this ConfigurationBuilder<TInterface> builder, IBlobStorage blobStorage) where TInterface : class
      {
